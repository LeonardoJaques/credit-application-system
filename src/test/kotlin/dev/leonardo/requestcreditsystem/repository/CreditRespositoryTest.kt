...
class CreditRespositoryTest {
    ...
    fun `should find credit by credit code`() {
        //given
        val creditCode1 = UUID.fromString("9879dc50-5371-4a43-86f2-b8a76b1428fc")
        val creditCode2 = UUID.fromString("f3be2339-da2d-4711-ac9c-44e892ba25e4")
    ...
    fun `should find all credits by customer id`() {
        ...
        //when
        val creditList: List<Credit> = creditRepository.findAllVByCustomerId(customerId)
       //then
